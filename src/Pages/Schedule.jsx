...
const Schedule = () => {
    ...
    piketGroup = [
        ["Bilqis", "Hyuga", "Fany", "Aqila", "Farah", "Dodik", "Ilham"],
        ["Nur", "Alan", "Farichan", "Firsha", "Sarisma", "Dini", "Tyo"],
        ["Akbar", "Alif", "Rafie", "Hendrico", "Firla", "Dwita", "Khanaya"],
        ["Daega", "Khalfany", "Rafi", "Anisa", "Intan", "Cilla", "Nabila"],
        ["Candika", "Fardan", "Daffa", "Adrian", "Fiza", "Talitha", "Ayzira"],
    ]
